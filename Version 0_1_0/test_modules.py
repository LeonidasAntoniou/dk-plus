...
(params_1.global_lat, params_1.global_lon,  params_1.global_alt) = get_location_metres(self_params.global_lat, self_params.global_lon, self_params.global_alt, 8, -8)
(params_2.global_lat, params_2.global_lon,  params_2.global_alt) = get_location_metres(self_params.global_lat, self_params.global_lon, self_params.global_alt, 30, -30)
params.append(params_1)
params.append(params_2)

time.sleep(2)

(params_3.global_lat, params_3.global_lon,  params_3.global_alt) = get_location_metres(self_params.global_lat, self_params.global_lon, self_params.global_alt, 5, -5)
(params_4.global_lat, params_4.global_lon,  params_4.global_alt) = get_location_metres(self_params.global_lat, self_params.global_lon, self_params.global_alt, 60, -60)
