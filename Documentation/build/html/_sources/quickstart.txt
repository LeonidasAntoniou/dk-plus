...
.. warning::
	This API was developed for :strong:`Dronekit-Python 2.x` so it is not guaranteed that future versions of Dronekit will be backwards compatible with :strong:`DK+`. 
...
.. tip::
	If you receive packets but the program is not receiving it without any raised exception, then probably the packets are blocked by your firewall.
...
If you run a Linux distribution then you may have to change `iptables <https://help.ubuntu.com/community/IptablesHowTo>`_ to accept a selection/all incoming and outgoing UDP packets. 

.. warning::
	The following command adds two firewall exceptions, to accept incoming and outgoing UDP packets. Be extra careful and proceed at your own risk.
